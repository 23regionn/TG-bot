...
class PaysResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATE_PAYS_SUBSCRIPTIONS = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_PAYS_SUBSCRIPTIONS = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final String DEFAULT_LINK = "AAAAAAAAAA";
    private static final String UPDATED_LINK = "BBBBBBBBBB";

    private static final Double DEFAULT_SUM_FOR_PAYS = 1D;
    private static final Double UPDATED_SUM_FOR_PAYS = 2D;

    private static final String DEFAULT_TYPE_BUY = "AAAAAAAAAA";
    private static final String UPDATED_TYPE_BUY = "BBBBBBBBBB";

    private static final String DEFAULT_CATEGORY = "AAAAAAAAAA";
    private static final String UPDATED_CATEGORY = "BBBBBBBBBB";

    private static final Long DEFAULT_TYPE_BUY_LONG = 1L;
    private static final Long UPDATED_TYPE_BUY_LONG = 2L;
    ...
    public static Pays createEntity(EntityManager em) {
        Pays pays = new Pays()
            .datePaysSubscriptions(DEFAULT_DATE_PAYS_SUBSCRIPTIONS)
            .link(DEFAULT_LINK)
            .sumForPays(DEFAULT_SUM_FOR_PAYS)
            .typeBuy(DEFAULT_TYPE_BUY)
            .category(DEFAULT_CATEGORY)
            .typeBuyLong(DEFAULT_TYPE_BUY_LONG)
    ...
    public static Pays createUpdatedEntity(EntityManager em) {
        Pays pays = new Pays()
            .datePaysSubscriptions(UPDATED_DATE_PAYS_SUBSCRIPTIONS)
            .link(UPDATED_LINK)
            .sumForPays(UPDATED_SUM_FOR_PAYS)
            .typeBuy(UPDATED_TYPE_BUY)
            .category(UPDATED_CATEGORY)
            .typeBuyLong(UPDATED_TYPE_BUY_LONG)
    ...
    void createPays() throws Exception {
        ...
        assertThat(testPays.getDatePaysSubscriptions()).isEqualTo(DEFAULT_DATE_PAYS_SUBSCRIPTIONS);
        assertThat(testPays.getLink()).isEqualTo(DEFAULT_LINK);
        assertThat(testPays.getSumForPays()).isEqualTo(DEFAULT_SUM_FOR_PAYS);
        assertThat(testPays.getTypeBuy()).isEqualTo(DEFAULT_TYPE_BUY);
        assertThat(testPays.getCategory()).isEqualTo(DEFAULT_CATEGORY);
        assertThat(testPays.getTypeBuyLong()).isEqualTo(DEFAULT_TYPE_BUY_LONG);
        assertThat(testPays.getDate1()).isEqualTo(DEFAULT_DATE_1);
        assertThat(testPays.getDate2()).isEqualTo(DEFAULT_DATE_2);
        assertThat(testPays.getLong1()).isEqualTo(DEFAULT_LONG_1);
        assertThat(testPays.getString1()).isEqualTo(DEFAULT_STRING_1);
        assertThat(testPays.getBoolean1()).isEqualTo(DEFAULT_BOOLEAN_1);
    }
    ...
    void getAllPays() throws Exception {
        ...
        restPaysMockMvc
            ...
            .andExpect(jsonPath("$.[*].datePaysSubscriptions").value(hasItem(sameInstant(DEFAULT_DATE_PAYS_SUBSCRIPTIONS))))
            .andExpect(jsonPath("$.[*].link").value(hasItem(DEFAULT_LINK)))
            .andExpect(jsonPath("$.[*].sumForPays").value(hasItem(DEFAULT_SUM_FOR_PAYS.doubleValue())))
            .andExpect(jsonPath("$.[*].typeBuy").value(hasItem(DEFAULT_TYPE_BUY)))
            .andExpect(jsonPath("$.[*].category").value(hasItem(DEFAULT_CATEGORY)))
            .andExpect(jsonPath("$.[*].typeBuyLong").value(hasItem(DEFAULT_TYPE_BUY_LONG.intValue())))
    ...
    void getPays() throws Exception {
        ...
        restPaysMockMvc
            ...
            .andExpect(jsonPath("$.datePaysSubscriptions").value(sameInstant(DEFAULT_DATE_PAYS_SUBSCRIPTIONS)))
            .andExpect(jsonPath("$.link").value(DEFAULT_LINK))
            .andExpect(jsonPath("$.sumForPays").value(DEFAULT_SUM_FOR_PAYS.doubleValue()))
            .andExpect(jsonPath("$.typeBuy").value(DEFAULT_TYPE_BUY))
            .andExpect(jsonPath("$.category").value(DEFAULT_CATEGORY))
            .andExpect(jsonPath("$.typeBuyLong").value(DEFAULT_TYPE_BUY_LONG.intValue()))
    ...
    void putNewPays() throws Exception {
        ...
        Pays testPays = paysList.get(paysList.size() - 1);
        assertThat(testPays.getDatePaysSubscriptions()).isEqualTo(UPDATED_DATE_PAYS_SUBSCRIPTIONS);
        assertThat(testPays.getLink()).isEqualTo(UPDATED_LINK);
        assertThat(testPays.getSumForPays()).isEqualTo(UPDATED_SUM_FOR_PAYS);
        assertThat(testPays.getTypeBuy()).isEqualTo(UPDATED_TYPE_BUY);
        assertThat(testPays.getCategory()).isEqualTo(UPDATED_CATEGORY);
        assertThat(testPays.getTypeBuyLong()).isEqualTo(UPDATED_TYPE_BUY_LONG);
        assertThat(testPays.getDate1()).isEqualTo(UPDATED_DATE_1);
        assertThat(testPays.getDate2()).isEqualTo(UPDATED_DATE_2);
        assertThat(testPays.getLong1()).isEqualTo(UPDATED_LONG_1);
        assertThat(testPays.getString1()).isEqualTo(UPDATED_STRING_1);
        assertThat(testPays.getBoolean1()).isEqualTo(UPDATED_BOOLEAN_1);
    }
