...
class CityResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATE_CREATE_CITY = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_CREATE_CITY = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().cityName(DEFAULT_CITY_NAME).dateCreateCity(DEFAULT_DATE_CREATE_CITY).status(DEFAULT_STATUS);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().cityName(UPDATED_CITY_NAME).dateCreateCity(UPDATED_DATE_CREATE_CITY).status(UPDATED_STATUS);
        return city;
    }
    ...
    void createCity() throws Exception {
        ...
        assertThat(testCity.getDateCreateCity()).isEqualTo(DEFAULT_DATE_CREATE_CITY);
    ...
    void getAllCities() throws Exception {
        ...
        restCityMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateCreateCity").value(hasItem(sameInstant(DEFAULT_DATE_CREATE_CITY))))
    ...
    void getCity() throws Exception {
        ...
        restCityMockMvc
            ...
            .andExpect(jsonPath("$.dateCreateCity").value(sameInstant(DEFAULT_DATE_CREATE_CITY)))
    ...
    void putNewCity() throws Exception {
        ...
        updatedCity.cityName(UPDATED_CITY_NAME).dateCreateCity(UPDATED_DATE_CREATE_CITY).status(UPDATED_STATUS);
        ...
        assertThat(testCity.getDateCreateCity()).isEqualTo(UPDATED_DATE_CREATE_CITY);
    ...
    void fullUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.cityName(UPDATED_CITY_NAME).dateCreateCity(UPDATED_DATE_CREATE_CITY).status(UPDATED_STATUS);
