...
class ManagerResourceIT {
    ...
    public static Manager createEntity(EntityManager em) {
        Manager manager = new Manager().name(DEFAULT_NAME).contact(DEFAULT_CONTACT);
        return manager;
    }
    ...
    public static Manager createUpdatedEntity(EntityManager em) {
        Manager manager = new Manager().name(UPDATED_NAME).contact(UPDATED_CONTACT);
        return manager;
    }
    ...
    void createManager() throws Exception {
        ...
        assertThat(testManager.getContact()).isEqualTo(DEFAULT_CONTACT);
    }
    ...
    void putNewManager() throws Exception {
        ...
        updatedManager.name(UPDATED_NAME).contact(UPDATED_CONTACT);
        ...
        assertThat(testManager.getContact()).isEqualTo(UPDATED_CONTACT);
    }
    ...
    void fullUpdateManagerWithPatch() throws Exception {
        ...
        partialUpdatedManager.name(UPDATED_NAME).contact(UPDATED_CONTACT);
