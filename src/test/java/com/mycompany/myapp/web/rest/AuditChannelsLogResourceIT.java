...
class AuditChannelsLogResourceIT {
    ...
    private static final String DEFAULT_OLD_CONTACTS = "AAAAAAAAAA";
    private static final String UPDATED_OLD_CONTACTS = "BBBBBBBBBB";

    private static final ZonedDateTime DEFAULT_OLD_END_PUBLIC_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_OLD_END_PUBLIC_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final Boolean DEFAULT_OLD_IS_MODERATE = false;
    private static final Boolean UPDATED_OLD_IS_MODERATE = true;

    private static final Boolean DEFAULT_OLD_IS_PAY = false;
    private static final Boolean UPDATED_OLD_IS_PAY = true;

    private static final ZonedDateTime DEFAULT_OLD_LAST_PAY_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_OLD_LAST_PAY_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final String DEFAULT_OLD_LINK = "AAAAAAAAAA";
    private static final String UPDATED_OLD_LINK = "BBBBBBBBBB";

    private static final String DEFAULT_OLD_NAME_CHANNEL = "AAAAAAAAAA";
    private static final String UPDATED_OLD_NAME_CHANNEL = "BBBBBBBBBB";

    private static final String DEFAULT_OLD_PRICE_FOR_PAY = "AAAAAAAAAA";
    private static final String UPDATED_OLD_PRICE_FOR_PAY = "BBBBBBBBBB";

    private static final ZonedDateTime DEFAULT_OLD_START_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_OLD_START_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final Long DEFAULT_OLD_COUNT_SUBSCRIBERS = 1L;
    private static final Long UPDATED_OLD_COUNT_SUBSCRIBERS = 2L;

    private static final Long DEFAULT_OLD_COUNT_VIEWS = 1L;
    private static final Long UPDATED_OLD_COUNT_VIEWS = 2L;
    ...
    public static AuditChannelsLog createEntity(EntityManager em) {
        AuditChannelsLog auditChannelsLog = new AuditChannelsLog()
            ...
            .oldContacts(DEFAULT_OLD_CONTACTS)
            .oldEndPublicDate(DEFAULT_OLD_END_PUBLIC_DATE)
            .oldIsModerate(DEFAULT_OLD_IS_MODERATE)
            .oldIsPay(DEFAULT_OLD_IS_PAY)
            .oldLastPayDate(DEFAULT_OLD_LAST_PAY_DATE)
            .oldLink(DEFAULT_OLD_LINK)
            .oldNameChannel(DEFAULT_OLD_NAME_CHANNEL)
            .oldPriceForPay(DEFAULT_OLD_PRICE_FOR_PAY)
            .oldStartDate(DEFAULT_OLD_START_DATE)
            .oldCountSubscribers(DEFAULT_OLD_COUNT_SUBSCRIBERS)
            .oldCountViews(DEFAULT_OLD_COUNT_VIEWS);
    ...
    public static AuditChannelsLog createUpdatedEntity(EntityManager em) {
        AuditChannelsLog auditChannelsLog = new AuditChannelsLog()
            ...
            .oldContacts(UPDATED_OLD_CONTACTS)
            .oldEndPublicDate(UPDATED_OLD_END_PUBLIC_DATE)
            .oldIsModerate(UPDATED_OLD_IS_MODERATE)
            .oldIsPay(UPDATED_OLD_IS_PAY)
            .oldLastPayDate(UPDATED_OLD_LAST_PAY_DATE)
            .oldLink(UPDATED_OLD_LINK)
            .oldNameChannel(UPDATED_OLD_NAME_CHANNEL)
            .oldPriceForPay(UPDATED_OLD_PRICE_FOR_PAY)
            .oldStartDate(UPDATED_OLD_START_DATE)
            .oldCountSubscribers(UPDATED_OLD_COUNT_SUBSCRIBERS)
            .oldCountViews(UPDATED_OLD_COUNT_VIEWS);
        return auditChannelsLog;
    }
    ...
    void createAuditChannelsLog() throws Exception {
        ...
        assertThat(testAuditChannelsLog.getOldComment()).isEqualTo(DEFAULT_OLD_COMMENT);
        assertThat(testAuditChannelsLog.getOldContacts()).isEqualTo(DEFAULT_OLD_CONTACTS);
        assertThat(testAuditChannelsLog.getOldEndPublicDate()).isEqualTo(DEFAULT_OLD_END_PUBLIC_DATE);
        assertThat(testAuditChannelsLog.getOldIsModerate()).isEqualTo(DEFAULT_OLD_IS_MODERATE);
        assertThat(testAuditChannelsLog.getOldIsPay()).isEqualTo(DEFAULT_OLD_IS_PAY);
        assertThat(testAuditChannelsLog.getOldLastPayDate()).isEqualTo(DEFAULT_OLD_LAST_PAY_DATE);
        assertThat(testAuditChannelsLog.getOldLink()).isEqualTo(DEFAULT_OLD_LINK);
        assertThat(testAuditChannelsLog.getOldNameChannel()).isEqualTo(DEFAULT_OLD_NAME_CHANNEL);
        assertThat(testAuditChannelsLog.getOldPriceForPay()).isEqualTo(DEFAULT_OLD_PRICE_FOR_PAY);
        assertThat(testAuditChannelsLog.getOldStartDate()).isEqualTo(DEFAULT_OLD_START_DATE);
        assertThat(testAuditChannelsLog.getOldCountSubscribers()).isEqualTo(DEFAULT_OLD_COUNT_SUBSCRIBERS);
        assertThat(testAuditChannelsLog.getOldCountViews()).isEqualTo(DEFAULT_OLD_COUNT_VIEWS);
    }
    ...
    void getAllAuditChannelsLogs() throws Exception {
        ...
        restAuditChannelsLogMockMvc
            ...
            .andExpect(jsonPath("$.[*].oldContacts").value(hasItem(DEFAULT_OLD_CONTACTS)))
            .andExpect(jsonPath("$.[*].oldEndPublicDate").value(hasItem(sameInstant(DEFAULT_OLD_END_PUBLIC_DATE))))
            .andExpect(jsonPath("$.[*].oldIsModerate").value(hasItem(DEFAULT_OLD_IS_MODERATE.booleanValue())))
            .andExpect(jsonPath("$.[*].oldIsPay").value(hasItem(DEFAULT_OLD_IS_PAY.booleanValue())))
            .andExpect(jsonPath("$.[*].oldLastPayDate").value(hasItem(sameInstant(DEFAULT_OLD_LAST_PAY_DATE))))
            .andExpect(jsonPath("$.[*].oldLink").value(hasItem(DEFAULT_OLD_LINK)))
            .andExpect(jsonPath("$.[*].oldNameChannel").value(hasItem(DEFAULT_OLD_NAME_CHANNEL)))
            .andExpect(jsonPath("$.[*].oldPriceForPay").value(hasItem(DEFAULT_OLD_PRICE_FOR_PAY)))
            .andExpect(jsonPath("$.[*].oldStartDate").value(hasItem(sameInstant(DEFAULT_OLD_START_DATE))))
            .andExpect(jsonPath("$.[*].oldCountSubscribers").value(hasItem(DEFAULT_OLD_COUNT_SUBSCRIBERS.intValue())))
            .andExpect(jsonPath("$.[*].oldCountViews").value(hasItem(DEFAULT_OLD_COUNT_VIEWS.intValue())));
    }
    ...
    void getAuditChannelsLog() throws Exception {
        ...
        restAuditChannelsLogMockMvc
            ...
            .andExpect(jsonPath("$.oldContacts").value(DEFAULT_OLD_CONTACTS))
            .andExpect(jsonPath("$.oldEndPublicDate").value(sameInstant(DEFAULT_OLD_END_PUBLIC_DATE)))
            .andExpect(jsonPath("$.oldIsModerate").value(DEFAULT_OLD_IS_MODERATE.booleanValue()))
            .andExpect(jsonPath("$.oldIsPay").value(DEFAULT_OLD_IS_PAY.booleanValue()))
            .andExpect(jsonPath("$.oldLastPayDate").value(sameInstant(DEFAULT_OLD_LAST_PAY_DATE)))
            .andExpect(jsonPath("$.oldLink").value(DEFAULT_OLD_LINK))
            .andExpect(jsonPath("$.oldNameChannel").value(DEFAULT_OLD_NAME_CHANNEL))
            .andExpect(jsonPath("$.oldPriceForPay").value(DEFAULT_OLD_PRICE_FOR_PAY))
            .andExpect(jsonPath("$.oldStartDate").value(sameInstant(DEFAULT_OLD_START_DATE)))
            .andExpect(jsonPath("$.oldCountSubscribers").value(DEFAULT_OLD_COUNT_SUBSCRIBERS.intValue()))
            .andExpect(jsonPath("$.oldCountViews").value(DEFAULT_OLD_COUNT_VIEWS.intValue()));
    }
    ...
    void putNewAuditChannelsLog() throws Exception {
        ...
        assertThat(testAuditChannelsLog.getOldComment()).isEqualTo(UPDATED_OLD_COMMENT);
        assertThat(testAuditChannelsLog.getOldContacts()).isEqualTo(UPDATED_OLD_CONTACTS);
        assertThat(testAuditChannelsLog.getOldEndPublicDate()).isEqualTo(UPDATED_OLD_END_PUBLIC_DATE);
        assertThat(testAuditChannelsLog.getOldIsModerate()).isEqualTo(UPDATED_OLD_IS_MODERATE);
        assertThat(testAuditChannelsLog.getOldIsPay()).isEqualTo(UPDATED_OLD_IS_PAY);
        assertThat(testAuditChannelsLog.getOldLastPayDate()).isEqualTo(UPDATED_OLD_LAST_PAY_DATE);
        assertThat(testAuditChannelsLog.getOldLink()).isEqualTo(UPDATED_OLD_LINK);
        assertThat(testAuditChannelsLog.getOldNameChannel()).isEqualTo(UPDATED_OLD_NAME_CHANNEL);
        assertThat(testAuditChannelsLog.getOldPriceForPay()).isEqualTo(UPDATED_OLD_PRICE_FOR_PAY);
        assertThat(testAuditChannelsLog.getOldStartDate()).isEqualTo(UPDATED_OLD_START_DATE);
        assertThat(testAuditChannelsLog.getOldCountSubscribers()).isEqualTo(UPDATED_OLD_COUNT_SUBSCRIBERS);
        assertThat(testAuditChannelsLog.getOldCountViews()).isEqualTo(UPDATED_OLD_COUNT_VIEWS);
    }
