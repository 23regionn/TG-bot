...
class ShowChannelsInCategoryLogResourceIT {
    ...
    private static final Boolean DEFAULT_OLD_IS_SHOW_CHANNEL = false;
    private static final Boolean UPDATED_OLD_IS_SHOW_CHANNEL = true;

    private static final Double DEFAULT_OLD_SCORE_CHANNEL = 1D;
    private static final Double UPDATED_OLD_SCORE_CHANNEL = 2D;
    ...
    public static ShowChannelsInCategoryLog createEntity(EntityManager em) {
        ShowChannelsInCategoryLog showChannelsInCategoryLog = new ShowChannelsInCategoryLog()
            ...
            .oldIsShowChannel(DEFAULT_OLD_IS_SHOW_CHANNEL)
            .oldScoreChannel(DEFAULT_OLD_SCORE_CHANNEL)
    ...
    public static ShowChannelsInCategoryLog createUpdatedEntity(EntityManager em) {
        ShowChannelsInCategoryLog showChannelsInCategoryLog = new ShowChannelsInCategoryLog()
            ...
            .oldIsShowChannel(UPDATED_OLD_IS_SHOW_CHANNEL)
            .oldScoreChannel(UPDATED_OLD_SCORE_CHANNEL)
    ...
    void createShowChannelsInCategoryLog() throws Exception {
        ...
        assertThat(testShowChannelsInCategoryLog.getOldIsShowChannel()).isEqualTo(DEFAULT_OLD_IS_SHOW_CHANNEL);
        assertThat(testShowChannelsInCategoryLog.getOldScoreChannel()).isEqualTo(DEFAULT_OLD_SCORE_CHANNEL);
        assertThat(testShowChannelsInCategoryLog.getOldComment()).isEqualTo(DEFAULT_OLD_COMMENT);
    ...
    void getAllShowChannelsInCategoryLogs() throws Exception {
        ...
        restShowChannelsInCategoryLogMockMvc
            ...
            .andExpect(jsonPath("$.[*].oldIsShowChannel").value(hasItem(DEFAULT_OLD_IS_SHOW_CHANNEL.booleanValue())))
            .andExpect(jsonPath("$.[*].oldScoreChannel").value(hasItem(DEFAULT_OLD_SCORE_CHANNEL.doubleValue())))
    ...
    void getShowChannelsInCategoryLog() throws Exception {
        ...
        restShowChannelsInCategoryLogMockMvc
            ...
            .andExpect(jsonPath("$.oldIsShowChannel").value(DEFAULT_OLD_IS_SHOW_CHANNEL.booleanValue()))
            .andExpect(jsonPath("$.oldScoreChannel").value(DEFAULT_OLD_SCORE_CHANNEL.doubleValue()))
    ...
    void putNewShowChannelsInCategoryLog() throws Exception {
        ...
        assertThat(testShowChannelsInCategoryLog.getOldIsShowChannel()).isEqualTo(UPDATED_OLD_IS_SHOW_CHANNEL);
        assertThat(testShowChannelsInCategoryLog.getOldScoreChannel()).isEqualTo(UPDATED_OLD_SCORE_CHANNEL);
        assertThat(testShowChannelsInCategoryLog.getOldComment()).isEqualTo(UPDATED_OLD_COMMENT);
