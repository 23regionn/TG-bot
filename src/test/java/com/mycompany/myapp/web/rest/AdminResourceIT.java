...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().name(DEFAULT_NAME).contact(DEFAULT_CONTACT).link(DEFAULT_LINK).isActive(DEFAULT_IS_ACTIVE);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().name(UPDATED_NAME).contact(UPDATED_CONTACT).link(UPDATED_LINK).isActive(UPDATED_IS_ACTIVE);
        return admin;
    }
    ...
    void createAdmin() throws Exception {
        ...
        assertThat(testAdmin.getContact()).isEqualTo(DEFAULT_CONTACT);
        assertThat(testAdmin.getLink()).isEqualTo(DEFAULT_LINK);
        assertThat(testAdmin.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.name(UPDATED_NAME).contact(UPDATED_CONTACT).link(UPDATED_LINK).isActive(UPDATED_IS_ACTIVE);
        ...
        assertThat(testAdmin.getContact()).isEqualTo(UPDATED_CONTACT);
        assertThat(testAdmin.getLink()).isEqualTo(UPDATED_LINK);
        assertThat(testAdmin.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
    }
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.link(UPDATED_LINK);
    ...
    void fullUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.name(UPDATED_NAME).contact(UPDATED_CONTACT).link(UPDATED_LINK).isActive(UPDATED_IS_ACTIVE);
