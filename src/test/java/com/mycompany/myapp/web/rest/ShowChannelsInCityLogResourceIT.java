...
class ShowChannelsInCityLogResourceIT {
    ...
    void createShowChannelsInCityLog() throws Exception {
        ...
        assertThat(testShowChannelsInCityLog.getOldIsShowChannel()).isEqualTo(DEFAULT_OLD_IS_SHOW_CHANNEL);
        assertThat(testShowChannelsInCityLog.getOldScoreChannel()).isEqualTo(DEFAULT_OLD_SCORE_CHANNEL);
        assertThat(testShowChannelsInCityLog.getOldComment()).isEqualTo(DEFAULT_OLD_COMMENT);
    ...
    void putNewShowChannelsInCityLog() throws Exception {
        ...
        assertThat(testShowChannelsInCityLog.getOldIsShowChannel()).isEqualTo(UPDATED_OLD_IS_SHOW_CHANNEL);
        assertThat(testShowChannelsInCityLog.getOldScoreChannel()).isEqualTo(UPDATED_OLD_SCORE_CHANNEL);
        assertThat(testShowChannelsInCityLog.getOldComment()).isEqualTo(UPDATED_OLD_COMMENT);
