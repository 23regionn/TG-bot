...
public class ShowChannelsInCategoryLog implements Serializable {
    ...
    public ShowChannelsInCategoryLog oldIsShowChannel(Boolean oldIsShowChannel) {
    ...
    public ShowChannelsInCategoryLog oldScoreChannel(Double oldScoreChannel) {
    ...
    public ShowChannelsInCategoryLog oldComment(String oldComment) {
