...
public class PaysResource {
    ...
    public ResponseEntity<Pays> updatePays(@PathVariable(value = "id", required = false) final Long id, @RequestBody Pays pays)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, pays.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Pays> partialUpdatePays(@PathVariable(value = "id", required = false) final Long id, @RequestBody Pays pays)
        ...
        Optional<Pays> result = paysRepository
            ...
            .map(
                existingPays -> {
                    if (pays.getDatePaysSubscriptions() != null) {
                        existingPays.setDatePaysSubscriptions(pays.getDatePaysSubscriptions());
                    }
                    if (pays.getLink() != null) {
                        existingPays.setLink(pays.getLink());
                    }
                    if (pays.getSumForPays() != null) {
                        existingPays.setSumForPays(pays.getSumForPays());
                    }
                    if (pays.getTypeBuy() != null) {
                        existingPays.setTypeBuy(pays.getTypeBuy());
                    }
                    if (pays.getCategory() != null) {
                        existingPays.setCategory(pays.getCategory());
                    }
                    if (pays.getTypeBuyLong() != null) {
                        existingPays.setTypeBuyLong(pays.getTypeBuyLong());
                    }
                    if (pays.getDate1() != null) {
                        existingPays.setDate1(pays.getDate1());
                    }
                    if (pays.getDate2() != null) {
                        existingPays.setDate2(pays.getDate2());
                    }
                    if (pays.getLong1() != null) {
                        existingPays.setLong1(pays.getLong1());
                    }
                    if (pays.getString1() != null) {
                        existingPays.setString1(pays.getString1());
                    }
                    if (pays.getBoolean1() != null) {
                        existingPays.setBoolean1(pays.getBoolean1());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, pays.getId().toString())
        );
    }
