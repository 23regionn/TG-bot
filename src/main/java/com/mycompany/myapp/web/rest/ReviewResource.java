        ...
        Optional<Review> result = reviewRepository
            ...
            .map(
                existingReview -> {
                    ...
                    if (review.getLinkToSaller() != null) {
                        existingReview.setLinkToSaller(review.getLinkToSaller());
                    }
                    if (review.getAdminId() != null) {
                        existingReview.setAdminId(review.getAdminId());
                    }
                    if (review.getIsNegative() != null) {
                        existingReview.setIsNegative(review.getIsNegative());
                    }
                    if (review.getIsDelete() != null) {
                        existingReview.setIsDelete(review.getIsDelete());
                    }
                    if (review.getDate1() != null) {
                        existingReview.setDate1(review.getDate1());
                    }
                    if (review.getDate2() != null) {
                        existingReview.setDate2(review.getDate2());
                    }
                    if (review.getLong1() != null) {
                        existingReview.setLong1(review.getLong1());
                    }
                    if (review.getString1() != null) {
                        existingReview.setString1(review.getString1());
                    }
                    if (review.getBoolean1() != null) {
                        existingReview.setBoolean1(review.getBoolean1());
                    }
