    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{showChannelsInCityLogEntity.oldIsShowChannel ? 'true' : 'false'}</dd>
          <dt>
            <span id="oldScoreChannel">Old Score Channel</span>
          </dt>
          <dd>{showChannelsInCityLogEntity.oldScoreChannel}</dd>
          <dt>
            <span id="oldComment">Old Comment</span>
          </dt>
          <dd>{showChannelsInCityLogEntity.oldComment}</dd>
          <dt>
