            ...
            <AvForm model={isNew ? {} : showChannelsInCityLogEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="oldIsShowChannelLabel">
                  <AvInput
                    id="show-channels-in-city-log-oldIsShowChannel"
              ...
              <AvGroup>
                <Label id="oldScoreChannelLabel" for="show-channels-in-city-log-oldScoreChannel">
                  Old Score Channel
                </Label>
                <AvField
                  id="show-channels-in-city-log-oldScoreChannel"
              ...
              <AvGroup>
                <Label id="oldCommentLabel" for="show-channels-in-city-log-oldComment">
                  Old Comment
                </Label>
                <AvField id="show-channels-in-city-log-oldComment" data-cy="oldComment" type="text" name="oldComment" />
              </AvGroup>
              <AvGroup>
