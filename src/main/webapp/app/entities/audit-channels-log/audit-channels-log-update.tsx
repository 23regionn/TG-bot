...
export const AuditChannelsLogUpdate = (props: IAuditChannelsLogUpdateProps) => {
  ...
  const saveEntity = (event, errors, values) => {
    ...
    values.oldEndPublicDate = convertDateTimeToServer(values.oldEndPublicDate);
    values.oldLastPayDate = convertDateTimeToServer(values.oldLastPayDate);
    values.oldStartDate = convertDateTimeToServer(values.oldStartDate);
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : auditChannelsLogEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="oldCommentLabel" for="audit-channels-log-oldComment">
                  Old Comment
                </Label>
                <AvField id="audit-channels-log-oldComment" data-cy="oldComment" type="text" name="oldComment" />
              </AvGroup>
              <AvGroup>
                <Label id="oldContactsLabel" for="audit-channels-log-oldContacts">
                  Old Contacts
                </Label>
                <AvField id="audit-channels-log-oldContacts" data-cy="oldContacts" type="text" name="oldContacts" />
              </AvGroup>
              <AvGroup>
                <Label id="oldEndPublicDateLabel" for="audit-channels-log-oldEndPublicDate">
                  Old End Public Date
                </Label>
                <AvInput
                  id="audit-channels-log-oldEndPublicDate"
                  data-cy="oldEndPublicDate"
                  type="datetime-local"
                  className="form-control"
                  name="oldEndPublicDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.auditChannelsLogEntity.oldEndPublicDate)}
                />
              </AvGroup>
              <AvGroup check>
                <Label id="oldIsModerateLabel">
                  <AvInput
                    id="audit-channels-log-oldIsModerate"
                    data-cy="oldIsModerate"
                    type="checkbox"
                    className="form-check-input"
                    name="oldIsModerate"
                  />
              ...
              <AvGroup check>
                <Label id="oldIsPayLabel">
                  <AvInput
                    id="audit-channels-log-oldIsPay"
                    data-cy="oldIsPay"
                    type="checkbox"
                    className="form-check-input"
                    name="oldIsPay"
              ...
              <AvGroup>
                <Label id="oldLastPayDateLabel" for="audit-channels-log-oldLastPayDate">
                  Old Last Pay Date
                </Label>
                <AvInput
                  id="audit-channels-log-oldLastPayDate"
                  data-cy="oldLastPayDate"
                  type="datetime-local"
                  className="form-control"
                  name="oldLastPayDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.auditChannelsLogEntity.oldLastPayDate)}
                />
              </AvGroup>
              <AvGroup>
                <Label id="oldLinkLabel" for="audit-channels-log-oldLink">
                  Old Link
                </Label>
                <AvField id="audit-channels-log-oldLink" data-cy="oldLink" type="text" name="oldLink" />
              </AvGroup>
              <AvGroup>
                <Label id="oldNameChannelLabel" for="audit-channels-log-oldNameChannel">
                  Old Name Channel
                </Label>
                <AvField id="audit-channels-log-oldNameChannel" data-cy="oldNameChannel" type="text" name="oldNameChannel" />
              </AvGroup>
              <AvGroup>
                <Label id="oldPriceForPayLabel" for="audit-channels-log-oldPriceForPay">
                  Old Price For Pay
                </Label>
                <AvField id="audit-channels-log-oldPriceForPay" data-cy="oldPriceForPay" type="text" name="oldPriceForPay" />
              </AvGroup>
              <AvGroup>
                <Label id="oldStartDateLabel" for="audit-channels-log-oldStartDate">
                  Old Start Date
                </Label>
                <AvInput
                  id="audit-channels-log-oldStartDate"
                  data-cy="oldStartDate"
                  type="datetime-local"
                  className="form-control"
                  name="oldStartDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.auditChannelsLogEntity.oldStartDate)}
                />
              </AvGroup>
              <AvGroup>
                <Label id="oldCountSubscribersLabel" for="audit-channels-log-oldCountSubscribers">
                  Old Count Subscribers
                </Label>
                <AvField
                  id="audit-channels-log-oldCountSubscribers"
                  data-cy="oldCountSubscribers"
                  type="string"
                  className="form-control"
                  name="oldCountSubscribers"
                />
              </AvGroup>
              <AvGroup>
                <Label id="oldCountViewsLabel" for="audit-channels-log-oldCountViews">
                  Old Count Views
                </Label>
                <AvField
                  id="audit-channels-log-oldCountViews"
                  data-cy="oldCountViews"
                  type="string"
                  className="form-control"
                  name="oldCountViews"
                />
