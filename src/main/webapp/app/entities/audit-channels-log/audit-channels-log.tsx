          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>Old Comment</th>
                <th>Old Contacts</th>
                <th>Old End Public Date</th>
                <th>Old Is Moderate</th>
                <th>Old Is Pay</th>
                <th>Old Last Pay Date</th>
                <th>Old Link</th>
                <th>Old Name Channel</th>
                <th>Old Price For Pay</th>
                <th>Old Start Date</th>
                <th>Old Count Subscribers</th>
                <th>Old Count Views</th>
                <th />
              </tr>
            </thead>
            <tbody>
              {auditChannelsLogList.map((auditChannelsLog, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{auditChannelsLog.oldComment}</td>
                  <td>{auditChannelsLog.oldContacts}</td>
                  <td>
                    {auditChannelsLog.oldEndPublicDate ? (
                      <TextFormat type="date" value={auditChannelsLog.oldEndPublicDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{auditChannelsLog.oldIsModerate ? 'true' : 'false'}</td>
                  <td>{auditChannelsLog.oldIsPay ? 'true' : 'false'}</td>
                  <td>
                    {auditChannelsLog.oldLastPayDate ? (
                      <TextFormat type="date" value={auditChannelsLog.oldLastPayDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{auditChannelsLog.oldLink}</td>
                  <td>{auditChannelsLog.oldNameChannel}</td>
                  <td>{auditChannelsLog.oldPriceForPay}</td>
                  <td>
                    {auditChannelsLog.oldStartDate ? (
                      <TextFormat type="date" value={auditChannelsLog.oldStartDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{auditChannelsLog.oldCountSubscribers}</td>
                  <td>{auditChannelsLog.oldCountViews}</td>
