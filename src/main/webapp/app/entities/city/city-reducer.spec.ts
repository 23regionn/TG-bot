...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_CITY),
          REQUEST(ACTION_TYPES.UPDATE_CITY),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CITY),
          REQUEST(ACTION_TYPES.DELETE_CITY),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_CITY),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_CITY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CITY),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_CITY),
          payload: resolvedObject,
        },
      ];
