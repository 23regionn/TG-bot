    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="dateCreateCity">Date Create City</span>
          </dt>
          <dd>
            {cityEntity.dateCreateCity ? <TextFormat value={cityEntity.dateCreateCity} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
