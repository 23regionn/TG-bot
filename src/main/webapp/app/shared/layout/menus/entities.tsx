...
export const EntitiesMenu = props => (
  <NavDropdown icon="th-list" name="Entities" id="entity-menu" data-cy="entity" style={{ maxHeight: '80vh', overflow: 'auto' }}>
    ...
    <MenuItem icon="asterisk" to="/messege-pannel">
      Messege Pannel
    </MenuItem>
    <MenuItem icon="asterisk" to="/edit-channels">
      Edit Channels
    </MenuItem>
    ...
    <MenuItem icon="asterisk" to="/rel-category-city">
      Rel Category City
    </MenuItem>
    <MenuItem icon="asterisk" to="/rel-category-city-channels">
      Rel Category City Channels
    </MenuItem>
    <MenuItem icon="asterisk" to="/search-type-log">
      Search Type Log
    </MenuItem>
