...
import { createCategory, getOnlyCategories, partialUpdateCategory } from '../all-categories/all-categories.reducer';
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <div>
          <Button id="button_basic" label="Создать категорию" onClick={createCategory} />
        </div>
      </div>
